...
class Face_Recognition:
    def __init__(self, root):
        ...
        # Add text on canvas
        canvas.create_text(self.root.winfo_screenwidth() // 2, 40, text="FACE RECOGNITION PANEL", font=("Algerian", 30, "bold"), fill="white")


        # Create buttons below the section 
        # ------------------------------------------------------------------------------------------------------------------- 
        # Face detector button 1
        ...
        std_b1_1 = Button(self.root, command=self.face_recog, text="FACE DETECTOR", cursor="hand2", font=("tahoma", 15, "bold"), bg="white", fg="#003151")
