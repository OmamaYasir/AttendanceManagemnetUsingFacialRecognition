...
class Train:
    ...
    def __init__(self,root):
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn = Image.open(r"C:\Users\PMLS\OneDrive\Documents\Python_Test_Projects\Images_GUI\t_btn1.png")
        ...
        std_b1_1 = Button(self.root, command=self.train_classifier, text="TRAIN DATASET", cursor="hand2", font=("tahoma", 15, "bold"), bg="white", fg="#003151")
