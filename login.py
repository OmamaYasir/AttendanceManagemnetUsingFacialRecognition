...
class Login:
    def __init__(self,root):
        ...
        img1=Image.open(r"C:\Users\PMLS\OneDrive\Documents\Python_Test_Projects\Images_GUI\log1.png")
        ...
        forgetbtn=Button(frame1,command=self.forget_pwd,text="Forgot Password?",font=("Helvetica",10,"bold"),bd=0,relief=RIDGE,fg="#007bff",bg="white",activeforeground="orange",activebackground="#002B53")
        forgetbtn.place(x=207, y=270, width=150, height=20) 
        
        # Creating Button Login
        loginbtn=Button(frame1,command=self.login,text="LOGIN",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="white",bg="#002B53",activeforeground="white",activebackground="#abb9c4",padx=10)
        ...
        loginbtn=Button(frame1,command=self.reg,text="Register",font=("Helvetica",10,"bold"),bd=0,relief=RIDGE,fg="#007bff",bg="white",activeforeground="orange",activebackground="#002B53")
