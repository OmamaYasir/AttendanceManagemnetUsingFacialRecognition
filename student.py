...
class Student:
    def __init__(self,root):
        ...
        self.entry_std_name = Entry(self.root, textvariable=self.var_std_name, validate="key", validatecommand=(self.root.register(self.validate_name), '%P'))
    ...
    # This is the part where image labels setting start 
        ...
        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("verdana",12,"bold"),fg="#003151")
        left_frame.place(x=10,y=10,width=660,height=480)
        # Current Course 
        current_course_frame = LabelFrame(left_frame,bd=2,bg="white",relief=RIDGE,text="Current Course",font=("verdana",12,"bold"),fg="#003151")
        current_course_frame.place(x=10,y=5,width=635,height=150)
        #label Department
        dep_label=Label(current_course_frame,text="Department",font=("verdana",12,"bold"),bg="white",fg="#003151")
        ...
        #-----------------------------------------------------------------
        #label Semester 
        year_label=Label(current_course_frame,text="Semester",font=("verdana",12,"bold"),bg="white",fg="#003151")
        ...
        class_Student_frame = LabelFrame(left_frame,bd=2,bg="white",relief=RIDGE,text="Class Student Information",font=("verdana",12,"bold"),fg="#003151")
        class_Student_frame.place(x=10,y=160,width=635,height=230)
        #Student id
        studentId_label = Label(class_Student_frame,text="Std-ID:",font=("verdana",12,"bold"),fg="#003151",bg="white")
        ...
        #Student name
        student_name_label = Label(class_Student_frame,text="Std-Name:",font=("verdana",12,"bold"),fg="#003151",bg="white")
        ...
        #Class Didvision
        student_div_label = Label(class_Student_frame,text="Class Division:",font=("verdana",12,"bold"),fg="#003151",bg="white")
        ...
        #Roll No
        student_roll_label = Label(class_Student_frame,text="Roll-No:",font=("verdana",12,"bold"),fg="#003151",bg="white")
        ...
        #Gender
        student_gender_label = Label(class_Student_frame,text="Gender:",font=("verdana",12,"bold"),fg="#003151",bg="white")
        ...
        #Date of Birth
        student_dob_label = Label(class_Student_frame,text="DOB:",font=("verdana",12,"bold"),fg="#003151",bg="white")
        ...
        #Email
        student_email_label = Label(class_Student_frame,text="Email:",font=("verdana",12,"bold"),fg="#003151",bg="white")
        ...
        #Phone Number
        student_mob_label = Label(class_Student_frame,text="Mob-No:",font=("verdana",12,"bold"),fg="#003151",bg="white")
        ...
        #Address
        student_address_label = Label(class_Student_frame,text="Address:",font=("verdana",12,"bold"),fg="#003151",bg="white")
        ...
        #Teacher Name
        student_tutor_label = Label(class_Student_frame,text="Tutor Name:",font=("verdana",12,"bold"),fg="#003151",bg="white")
        ...
        #save button
        save_btn=Button(btn_frame,command=self.add_data,text="Save",width=7,font=("verdana",12,"bold"),fg="white",bg="#003151")
        save_btn.grid(row=0,column=0,padx=5,pady=10,sticky=W)
        #update button
        update_btn=Button(btn_frame,command=self.update_data,text="Update",width=7,font=("verdana",12,"bold"),fg="white",bg="#003151")
        update_btn.grid(row=0,column=1,padx=5,pady=8,sticky=W)
        #delete button
        del_btn=Button(btn_frame,command=self.delete_data,text="Delete",width=7,font=("verdana",12,"bold"),fg="white",bg="#003151")
        del_btn.grid(row=0,column=2,padx=5,pady=10,sticky=W)
        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=7,font=("verdana",12,"bold"),fg="white",bg="#003151")
        reset_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)
        #take photo button
        take_photo_btn=Button(btn_frame,command=self.generate_dataset,text="Take Pic",width=9,font=("verdana",12,"bold"),fg="white",bg="#003151")
        take_photo_btn.grid(row=0,column=4,padx=5,pady=10,sticky=W)
        #update photo button
        update_photo_btn=Button(btn_frame,command=self.update_photo,text="Update Pic",width=9,font=("verdana",12,"bold"),fg="white",bg="#003151")
        update_photo_btn.grid(row=0,column=5,padx=5,pady=10,sticky=W)

        #----------------------------------------------------------------------
        # Right Label Frame 
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("verdana",12,"bold"),fg="#003151")
        right_frame.place(x=680,y=10,width=660,height=480)
        #Search System in Right Label Frame 
        search_frame = LabelFrame(right_frame,bd=2,bg="white",relief=RIDGE,text="Search System",font=("verdana",12,"bold"),fg="#003151")
        ...
        search_btn=Button(search_frame,command=self.search_data,text="Search",width=9,font=("verdana",12,"bold"),fg="white",bg="#003151")
        search_btn.grid(row=0,column=3,padx=5,pady=10,sticky=W)

        showAll_btn=Button(search_frame,command=self.fetch_data,text="Show All",width=8,font=("verdana",12,"bold"),fg="white",bg="#003151")
    ...
    def add_data(self):
        ...
        if (self.var_dep.get() == "Select Department" or 
            ...
            if not re.match("^[A-Za-z ]+$", self.var_std_name.get()):
                messagebox.showerror("Error", "Invalid Student Name! Name should only contain alphabets and spaces.", parent=self.root)
                return
            if not re.match("^[A-Za-z ]+$", self.var_teacher.get()):
                messagebox.showerror("Error", "Invalid Teacher Name! Name should only contain alphabets and spaces.", parent=self.root)
                return
            # Validate mobile number (must be exactly 11 digits)
            if not re.match("^\d{11}$", self.var_mob.get()):
                messagebox.showerror("Error", "Invalid Mobile Number! It should be exactly 11 digits.", parent=self.root)
                return
        ...
        if (self.var_dep.get() == "Select Department" or 
            ...
            try:
                ...
                if Update:
                    ...
                    mycursor.execute("SELECT * FROM student WHERE Roll_No = %s AND Student_ID != %s", (self.var_roll.get(), self.var_std_id.get()))
                    row = mycursor.fetchone()
                    if row:
                        messagebox.showerror("Error", "Roll Number already exists!", parent=self.root)
                        conn.close()
