...
class Register:
    def __init__(self,root):
        ...
        # ========================= Section 3 --- 1 Columan=================
        #label1 
        ssq =lb1= Label(frame,text="Select Security Question:",font=("times new roman",15,"bold"),fg="#003151",bg="#F2F2F2")
        ...
        #label2 
        sa =lb1= Label(frame,text="Security Answer:",font=("times new roman",15,"bold"),fg="#003151",bg="#F2F2F2")
        ...
        #label2 
        cpwd =lb1= Label(frame,text="Confirm Password:",font=("times new roman",15,"bold"),fg="#003151",bg="#F2F2F2")
        ...
        loginbtn=Button(frame,command=self.reg,text="REGISTER",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="#003151",activeforeground="white",activebackground="#007ACC")
