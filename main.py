...
# This part is image labels setting start 
        # first header image  
        #img=Image.open(r"C:\Users\PMLS\OneDrive\Documents\Python_Test_Projects\Images_GUI\banner.jpg")
        ...
        # Add text on canvas
        canvas.create_text(self.root.winfo_screenwidth() // 2, 40, text="Attendance Management System Using Facial Recognition", font=("Algerian", 30, "bold"), fill="white")
        ...
        std_b1_1 = Button(self.root, command=self.student_pannels, text="STUDENT PANEL", cursor="hand2", font=("tahoma", 15, "bold"), bg="white", fg="#003151")
        ...
        det_b1_1 = Button(self.root, command=self.face_rec, text="FACE DETECTOR", cursor="hand2", font=("tahoma", 15, "bold"), bg="white", fg="#003151")
        ...
        att_b1_1 = Button(self.root, command=self.attendance_pannel, text="ATTENDANCE", cursor="hand2", font=("tahoma", 15, "bold"), bg="white", fg="#003151")
        ...
        tra_b1_1 = Button(self.root, command=self.train_pannels, text="TRAIN DATA", cursor="hand2", font=("tahoma", 15, "bold"), bg="white", fg="#003151")
        ...
        exi_b1_1 = Button(self.root, command=self.Data, text="IMAGES DATA", cursor="hand2", font=("tahoma", 15, "bold"), bg="white", fg="#003151")
        ...
        exi_b1_1 = Button(self.root, command=self.Close, text="LOG OUT", cursor="hand2", font=("tahoma", 15, "bold"), bg="white", fg="#003151")
